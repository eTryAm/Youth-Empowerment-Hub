...
export function DonationCta({ donationEnabled, donationUrl }: DonationCtaProps) {
  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden bg-gradient-to-b from-[#0A0F1C] via-[#0D1527] to-[#0A0F1C] text-white">
      ...
      <div className="container px-4 md:px-6 mx-auto relative z-10 max-w-6xl">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-orange-500/15 to-rose-500/15 border border-orange-400/30 text-orange-400 text-xs font-black uppercase tracking-wider shadow-sm">
              ...
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${tier.color} p-2.5 text-white flex items-center justify-center shadow-md`}>
                      <Icon className="w-6 h-6" />
                    </div>
                    <div className="text-right">
                      <span className="text-2xl sm:text-3xl font-black text-white">{tier.amount}</span>
                    </div>
                  </div>
                ...
                <div className="pt-5 mt-4 border-t border-white/5 flex items-center justify-between text-xs">
                  <span className={`font-bold ${isSelected ? 'text-orange-400' : 'text-slate-500'}`}>
                    {isSelected ? '✓ Selected Impact' : 'Click to Select'}
                  </span>
        ...
        <div className="rounded-3xl bg-gradient-to-r from-blue-900/40 via-indigo-900/40 to-orange-950/40 border border-white/15 p-8 sm:p-12 text-center shadow-2xl relative overflow-hidden backdrop-blur-xl">
          ...
          <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4">
              <motion.button
                ...
                className="relative inline-flex items-center justify-center gap-3 px-8 sm:px-10 py-4 sm:py-5 rounded-full bg-gradient-to-r from-[#F97316] via-[#EA580C] to-[#E11D48] text-white font-black text-lg sm:text-xl shadow-2xl shadow-orange-500/30 cursor-pointer overflow-hidden group"
              >
                ...
                <Heart className="w-6 h-6 fill-white text-white shrink-0 group-hover:scale-110 transition-transform" />
            ...
            {/* Trust Markers */}
            <div className="pt-4 flex items-center justify-center flex-wrap gap-4 sm:gap-8 text-xs text-slate-400 font-medium">
