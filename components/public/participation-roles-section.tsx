...
export function ParticipationRolesSection() {
  return (
    <section id="how-to-participate" className="py-20 sm:py-28 bg-[#0A0F1C] text-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
          ...
          {participationRoles.map((role, idx) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-3xl bg-white/[0.03] border border-white/10 p-6 sm:p-8 hover:border-white/20 hover:bg-white/[0.05] transition-all duration-300 flex flex-col justify-between group"
              >
                <div>
                  ...
                  <div className="space-y-2.5 pt-4 border-t border-white/5 text-xs">
                    <div className="flex items-start gap-2">
                      ...
                      <span className="text-slate-300">
                        <strong className="text-white font-semibold">Expected Role:</strong> {role.contribution}
                      </span>
                    </div>
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-blue-400 shrink-0 mt-0.5" />
                      <span className="text-slate-300">
                        <strong className="text-white font-semibold">Eligibility:</strong> {role.eligibility}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-5 border-t border-white/5">
                  <Button
                    asChild
                    className="w-full h-11 rounded-xl bg-white/10 hover:bg-blue-600 text-white font-semibold text-xs sm:text-sm transition-all shadow-none hover:shadow-lg hover:shadow-blue-500/20 border border-white/10 hover:border-blue-500"
                  >
        ...
        <div className="mt-12 text-center max-w-2xl mx-auto p-4 rounded-2xl bg-white/[0.02] border border-white/5 text-xs text-slate-400 leading-relaxed">
          <span className="font-semibold text-slate-300">Participation Notice:</span> All roles are volunteer and student participation opportunities created for experiential learning and community service. YEH does not offer salaried employment or make commercial placement guarantees.
        </div>
      </div>
    </section>
  );
